...
CC = cc 
OPT = -O2 -mavx -O3 -O4 -funroll-loops -ffast-math
...
targets = benchmark-naive benchmark-blocked benchmark-blas benchmark-blocked-sse
objects = benchmark.o dgemm-naive.o dgemm-blocked.o dgemm-blas.o dgemm-blocked-sse.o
